...
class CategoryBookMobile extends StatelessWidget {
  const CategoryBookMobile({Key? key}) : super(key: key);
                            ...
                            Expanded(
                             ...
                             Expanded(
                              child: Padding(
                                ...
                                child:  Text('الحقيقه والسراب الحقيقع والشرب',style: TextStyle(
                                  fontWeight: FontWeight.bold,
