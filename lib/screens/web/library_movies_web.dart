...
class LibraryMoviesWeb extends StatelessWidget {

  const LibraryMoviesWeb({Key? key}) : super(key: key);
            ...
            Expanded(
              child: Row(
                children: [
                        ...
                        Container(height: 50,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text('مسلسلاتي والافلامي',style: TextStyle(
                              ...
                              (size.width>820)?Container(
                                ...
                                child:  Row(
                                  children:  [
                                    Text('ابحث عن المسلسلات والافلام الخاصه بي',
                                      style: TextStyle(
                  ...
                  CardScreen(isBook: false,isFav: false, isLib: true,isMovies: false,),
                ],
              ),
            ),
            Card(
