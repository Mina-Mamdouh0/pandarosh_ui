...
class CategoryBookWeb extends StatefulWidget {
  const CategoryBookWeb({Key? key}) : super(key: key);

  @override
  State<CategoryBookWeb> createState() => _CategoryBookWebState();
}

class _CategoryBookWebState extends State<CategoryBookWeb> {
            ...
            Expanded(
              child: Row(
                children: [
                  ...
                  CardScreen(isBook: true,isFav: false, isLib: false,isMovies: false,),
                ],
              ),
            ),
            Card(
